...
/**
 * This class performs tests on the extensions to the AList class.
 * 
 * @author Charles Hoot
 * @version 4.0
 */
...
{
    private static AList<String> testList1 = new AList<String>();
    private static AList<String> testList2 = new AList<String>();
    private static AList<String> testList3 = new AList<String>();
    private static AList<String> testList4 = new AList<String>();
    private static AList<String> testList5 = new AList<String>();
    private static AList<String> testList6 = new AList<String>();
    private static AList<String> testList7 = new AList<String>();
    private static AList<String> testList8 = new AList<String>();
    private static AList<String> testList9 = new AList<String>();
    private static AList<String> testList10 = new AList<String>();
    private static AList<String> testList11 = new AList<String>();
    private static AList<String> testList12 = new AList<String>();
    private static AList<String> testList13 = new AList<String>();
    private static AList<String> testList14 = new AList<String>();
    private static AList<String> testList15 = new AList<String>();
    private static AList<String> testList16 = new AList<String>();
