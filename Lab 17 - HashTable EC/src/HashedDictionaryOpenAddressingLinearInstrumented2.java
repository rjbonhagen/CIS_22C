 ...
 * A class that implements the ADT dictionary by using hashing and
 ...
 This code is based on HashedDictionary from Chapter 22 of 
 ...
 */
public class HashedDictionaryOpenAddressingLinearInstrumented2<K,V> implements DictionaryInterface<K,V>
{
    ...
    public HashedDictionaryOpenAddressingLinearInstrumented2()
    {
        this(DEFAULT_CAPACITY); // Call next constructor
    } // end default constructor
    
    
    public HashedDictionaryOpenAddressingLinearInstrumented2(int initialCapacity)
    {
